...
module.exports = React.createClass({
    ...
    render() {
        ...
        return (
            <Modal show={this.props.show} onHide={this.props.onHide} title="CSV Upload">
...
31-232-25,15
14-231-21,-2`}</pre>
                <UploadField url={this.props.url+'?merge='+(this.state.merge ? 'true' : 'false')} onSuccess={this.props.onSuccess} />
            </Modal>
        );
    }
});
